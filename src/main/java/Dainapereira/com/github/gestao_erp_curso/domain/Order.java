...
import Dainapereira.com.github.gestao_erp_curso.domain.Enums.PaymentType;
...
public class Order {
  ...
  public Double getTotalOrderPrice(){
    return itens.stream().mapToDouble(ItemOrder::getPice).reduce(identity:0.0, Double::sum);
  }
